...
require (
	github.com/DataDog/datadog-agent/comp/api/authtoken v0.60.1
	...
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/impl v0.60.1
	github.com/DataDog/datadog-agent/pkg/config/structure v0.60.1
	github.com/DataDog/datadog-agent/pkg/util/defaultpaths v0.60.1
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/log/impl v0.60.1
	github.com/DataDog/datadog-agent/comp/core/log/impl-trace v0.60.1
	...
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.60.1
	github.com/DataDog/datadog-agent/comp/core/tagger/types v0.60.1
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.60.1
	github.com/DataDog/datadog-agent/comp/def v0.60.1
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.60.1
	github.com/DataDog/datadog-agent/comp/forwarder/orchestrator/orchestratorinterface v0.60.1
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.60.1
	github.com/DataDog/datadog-agent/comp/netflow/payload v0.60.1
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/def v0.60.1
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.60.1
	github.com/DataDog/datadog-agent/comp/otelcol/converter/def v0.60.1
	...
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-zstd v0.60.1
	...
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.60.1
	github.com/DataDog/datadog-agent/pkg/metrics v0.60.1
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.60.1
	github.com/DataDog/datadog-agent/pkg/orchestrator/model v0.60.1
	github.com/DataDog/datadog-agent/pkg/process/util/api v0.60.1
	github.com/DataDog/datadog-agent/pkg/proto v0.60.1
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.60.1
	...
	github.com/DataDog/datadog-agent/pkg/util/cache v0.60.1
	github.com/DataDog/datadog-agent/pkg/util/common v0.60.1
	github.com/DataDog/datadog-agent/pkg/util/containers/image v0.60.1
	...
	github.com/DataDog/datadog-agent/pkg/util/json v0.60.1
